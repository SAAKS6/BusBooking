            ...
            <form action="./home_process_form.php" method="post" class="booking_form">
              ...
              <div class="form_date"><!-- DIV START 2 -->
                ...
                <div class="depature_date dates">
                  ...
                  <input type="date" id="departureDate" name="departure_Date" value="2023-12-25" required>
                </div>

                <!-- Return Date => Only show for Round Trip-->
                <div class="return_date dates return_date_hide">
                  <label for="return_date">Return Date<span>*</span></label>
                  <input type="date" id="return_date" name="return_date" value="2023-12-25" required>
                </div>
              </div><!-- DIV END 2 -->
